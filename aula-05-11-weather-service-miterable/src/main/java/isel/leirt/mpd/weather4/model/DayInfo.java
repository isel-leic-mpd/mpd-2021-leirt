...
public class DayInfo {
	...
	private Function<DayInfo, MIterable<WeatherInfo>> temperatures;
	...
	public DayInfo(LocalDate date, double maxTempC, double minTempC,
	               ...
	               double moon_phase,
	               Function<DayInfo, MIterable<WeatherInfo>>  temperatures) {
		this.date = date;
	...
	public MIterable<WeatherInfo> temperatures() {
